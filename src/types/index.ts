...
/** 状态显示配置 */
export const STATUS_DISPLAY_CONFIG: Record<DataItemStatus, { label: string; color: string; icon: string }> = {
  ...
  [DataItemStatus.AI_REVIEWING]: { label: 'AI预审中', color: 'processing', icon: 'LoadingOutlined' },
...
export type { Severity, MatchedRule, FieldWarning, ReviewSuggestion, AIReviewResult } from './aiReview';
